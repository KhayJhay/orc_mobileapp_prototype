...
class Login_Search_Screen extends StatefulWidget {
  const Login_Search_Screen({super.key});

  @override
  State<Login_Search_Screen> createState() => _Login_Search_ScreenState();
}

class _Login_Search_ScreenState extends State<Login_Search_Screen> {
                          ...
                          ? Padding(
                              ...
                              child: Center(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'The business name ${_searchController.text} is available for use',
